...
<div class="row">
<div class="col-md-11" style="border-right: 3px solid green; overflow-y: scroll; height: 800px;">
    <div class="">
<h2 class="c-section-headline l-section-headline">
    <span class="c-section-headline__text">FOOTWEAR ARTICLES</span>
</h2>
</div>
	<div>
<?php
$sql3="SELECT * FROM items WHERE category='shoes' or category='boots' ORDER BY id DESC LIMIT 0, 8; ";
